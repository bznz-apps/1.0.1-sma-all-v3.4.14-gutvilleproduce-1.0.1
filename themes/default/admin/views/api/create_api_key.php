...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        echo admin_form_open("api_settings/create_api_key", $attrib); ?>
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_dropdown('level', $opts, set_value('level'), 'class="form-control tip select" id="level" required="required" style="width:100%;"'); ?>
                        </div>
                        <div class="form-group">

...
function cssStyle() {
  if ($.cookie("sma_style") == "light") {
    $('link[href="' + site.assets + 'styles/blue.css"]').attr(
      "disabled",
      "disabled"
    );
    ...
    $('link[href="' + site.assets + 'styles/light.css"]').attr(
      "disabled",
      "disabled"
    );
...
jQuery(document).ready(function(e) {
  window.location.hash
    ? e('#myTab a[href="' + window.location.hash + '"]').tab("show")
...
$(document).ready(function() {
  ...
  $(".input-pop").popover({
    ...
    title: function() {
      return (
        "<b>" + $('label[for="' + $(this).attr("id") + '"]').text() + "</b>"
      );
    }
  });
});
...
function refreshPage(start, end) {
  if (end) {
    window.location.replace(
      CURI + "/" + encodeURIComponent(start) + "/" + encodeURIComponent(end)
    );
  } else {
...
function decimalFormat(x) {
  return (
    '<div class="text-center">' + formatNumber(x != null ? x : 0) + "</div>"
  );
}
...
function checkbox(x) {
  return (
    '<div class="text-center"><input class="checkbox multi-select" type="checkbox" name="val[]" value="' +
    x +
    '" /></div>'
  );
}
...
function row_status(x) {
  if (x == null) {
    ...
    return (
      '<div class="text-center"><span class="row_status label label-warning">' +
      lang[x] +
      "</span></div>"
    );
  } else if (
    ...
    return (
      '<div class="text-center"><span class="row_status label label-success">' +
      lang[x] +
      "</span></div>"
    );
  } else if (x == "partial" || x == "transferring" || x == "ordered") {
    return (
      '<div class="text-center"><span class="row_status label label-info">' +
      lang[x] +
      "</span></div>"
    );
  } else if (x == "due" || x == "returned") {
    return (
      '<div class="text-center"><span class="row_status label label-danger">' +
      lang[x] +
      "</span></div>"
    );
  } else {
    return (
      '<div class="text-center"><span class="row_status label label-default">' +
      x +
      "</span></div>"
    );
  }
...
function pay_status(x) {
  if (x == null) {
    ...
    return (
      '<div class="text-center"><span class="payment_status label label-warning">' +
      lang[x] +
      "</span></div>"
    );
  } else if (
    ...
    return (
      '<div class="text-center"><span class="payment_status label label-success">' +
      lang[x] +
      "</span></div>"
    );
  } else if (x == "partial" || x == "transferring" || x == "ordered") {
    return (
      '<div class="text-center"><span class="payment_status label label-info">' +
      lang[x] +
      "</span></div>"
    );
  } else if (x == "due" || x == "returned") {
    return (
      '<div class="text-center"><span class="payment_status label label-danger">' +
      lang[x] +
      "</span></div>"
    );
  } else {
    return (
      '<div class="text-center"><span class="payment_status label label-default">' +
      x +
      "</span></div>"
    );
  }
...
function calculateTax(tax, amt, met) {
  if (tax && tax_rates) {
    ...
    if (tax.type == 1) {
      if (met == "0") {
        tax_val = formatDecimal(
          (amt * parseFloat(tax.rate)) / (100 + parseFloat(tax.rate)),
          4
        );
...
$(document).ready(function() {
  $("#view-customer").click(function() {
    if ($("input[name=customer]").val()) {
      $("#myModal").modal({
        remote:
          site.base_url + "customers/view/" + $("input[name=customer]").val()
      });
      $("#myModal").modal("show");
    }
  });
  $("#view-supplier").click(function() {
    if ($("input[name=supplier]").val()) {
      $("#myModal").modal({
        remote:
          site.base_url + "suppliers/view/" + $("input[name=supplier]").val()
      });
      $("#myModal").modal("show");
    }
  });
  $("body").on(
    "click",
    ".customer_details_link td:not(:first-child, :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".supplier_details_link td:not(:first-child, :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".product_link td:not(:first-child, :nth-child(2), :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".purchase_link td:not(:first-child, :nth-child(5), :nth-last-child(2), :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".transfer_link td:not(:first-child, :nth-last-child(3), :nth-last-child(2), :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".oreturn_link td:not(:first-child, :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".invoice_link td:not(:first-child, :nth-child(6), :nth-last-child(2), :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".invoice_link2 td:not(:first-child, :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".receipt_link td:not(:first-child, :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".quote_link td:not(:first-child, :nth-last-child(3), :nth-last-child(2), :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".delivery_link td:not(:first-child, :nth-last-child(2), :nth-last-child(3), :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  $("body").on(
    "click",
    ".adjustment_link td:not(:first-child, :nth-last-child(2), :last-child)",
    function() {
      $("#myModal").modal({
        remote:
          site.base_url +
  ...
  // *************************************************************************
  // STARTS HERE - ROW LINK TESTING

  // $("body").on(
  //   "click",
  //   ".supply_order_link td:not(:first-child, :nth-child(2), :last-child)",
  //   function() {
  //     $("#myModal").modal({
  //       remote:
  //         site.base_url +
  ...
  // $("body").on("click", ".supply_order_link", function() {
  //   $("#myModal").modal({
  //     remote:
  //       site.base_url +
  //       "suppliers/add_supply_order/" +
...
function openImg(img) {
  ...
  imgwindow.document.write(
    '<link rel="stylesheet" href="' +
      site.assets +
      'styles/helpers/bootstrap.min.css" type="text/css" />'
  );
  imgwindow.document.write(

...
class Suppliers_model extends CI_Model
{
    ...
    public function addSupplyOrder($data)
    {
        ...
        // WORKING
        // But make sure $data array here has elements with values, if elements
        // are null or empty, then it will not write to the database
        // echo '<br>';
        // echo "hello from addSupplyOrder model function data is: " . $data;
        ...
        //     // 'msgToSupplier' => $data['msgToSupplier'],
        //     // 'msgToReceiving' => $data['msgToReceiving'],
        // );
        // $this->db->insert('NEW_supply_orders', $data['supplier_id']);


        // if ($this->db->insert('supply_orders', $data)) {
        //     return true;
        // }
        // return false;
    }
    ...
    public function addSupplyOrderX($data, $items, $warehouse_qty, $product_attributes, $photos)
    {
        if ($this->db->insert('products', $data)) {
            $product_id = $this->db->insert_id();
    ...
    {
        // if ($this->db->delete('products', array('id' => $id)) && $this->db->delete('warehouses_products', array('product_id' => $id))) {
        if ($this->db->delete('NEW_supply_orders', array('id' => $id))) {
            // $this->db->delete('warehouses_products_variants', array('product_id' => $id));
            // $this->db->delete('product_variants', array('product_id' => $id));
            // $this->db->delete('product_photos', array('product_id' => $id));
            // $this->db->delete('product_prices', array('product_id' => $id));

...
class Sample2 extends MY_Controller
{
    ...
    //   // $this->load->view($this->theme . 'sample_views/view2', $this->data);
    //   // Use this to load view inside SMA custom footer and header, sidebar
    //   // $this->page_construct('sample_views/view2', $meta, $this->data);
    // }

    function loadViewSample2()
    {
      $this->load->view($this->theme . 'sample2/index', $this->data);
    }

    function pageConstructSample2()
    {
      $this->page_construct('sample2/index', $meta, $this->data);
    }

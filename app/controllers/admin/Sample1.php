...
class Sample1 extends MY_Controller
{
    ...
    // Or load page at index function
    // function index()
    // {
    //   // Use this to load a complete new view and clean with no SMA footer or headers nor sidebar
    //   // $this->load->view($this->theme . 'sample_views/view1', $this->data);
    //   // Use this to load view inside SMA custom footer and header, sidebar
    //   // $this->page_construct('sample_views/view1', $meta, $this->data);
    // }

    function loadViewSample1()
    {
      $this->load->view($this->theme . 'sample1/index', $this->data);
    }

    function pageConstructSample1()
    {
      $this->page_construct('sample1/index', $meta, $this->data);
    }

    ////////////////////////////////////////////////////////////////////////////

    // functon index
    // is the default entry point of logic for this controller

    // functon: get, add, delete, update

    // work with models
    // pass data to view pages

    // Here we declare functions
    // Many functions can be assigned to a view page
    // We pass variables to view pages in an array of data:
    //  $data['var1']

    // here we use helpers to:
    // check permissions
    // validate forms
    // apply rules
    ...
    function print_barcodes($product_id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $this->page_construct('sample-views/view1/print_barcodes', $meta, $this->data);
    ...
    function add($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->addProduct($data, $items, $warehouse_qty, $product_attributes, $photos)) {
            ...
            $this->page_construct('sample-views/view1/add', $meta, $this->data);
        }
    }
    ...
    function edit($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->updateProduct($id, $data, $items, $warehouse_qty, $product_attributes, $photos, $update_variants)) {
            ...
            $this->page_construct('sample-views/view1/edit', $meta, $this->data);
        }
    }
    ...
    function import_csv()
    {
        ...
        if ($this->form_validation->run() == true && !empty($items)) {
            ...
            $this->page_construct('sample-views/view1/import_csv', $meta, $this->data);
    ...
    function quantity_adjustments($warehouse_id = NULL)
    {
        ...
        $this->page_construct('sample-views/view1/quantity_adjustments', $meta, $this->data);
    }
    ...
    function add_adjustment($count_id = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->addAdjustment($data, $products)) {
            ...
            $this->page_construct('sample-views/view1/add_adjustment', $meta, $this->data);
    ...
    function edit_adjustment($id)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->updateAdjustment($id, $data, $products)) {
            ...
            $this->page_construct('sample-views/view1/edit_adjustment', $meta, $this->data);
    ...
    function add_adjustment_by_csv()
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->addAdjustment($data, $products)) {
            ...
            $this->page_construct('sample-views/view1/add_adjustment_by_csv', $meta, $this->data);
    ...
    function view($id = NULL)
    {
        ...
        $this->page_construct('sample-views/view1/view', $meta, $this->data);
    }
    ...
    function stock_counts($warehouse_id = NULL)
    {
        ...
        $this->page_construct('sample-views/view1/stock_counts', $meta, $this->data);
    }
    ...
    function count_stock($page = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->addStockCount($data)) {
            ...
            $this->page_construct('sample-views/view1/count_stock', $meta, $this->data);
    ...
    function finalize_count($id)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->finalizeStockCount($id, $data, $products)) {
            ...
            $this->page_construct('sample-views/view1/finalize_count', $meta, $this->data);

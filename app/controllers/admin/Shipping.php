...
class Shipping extends MY_Controller
{
    ...
    {
      $this->page_construct('shipping/list_of_pickup_orders', $meta, $this->data);
    }

    function addPickupOrder()
    {
      $this->page_construct('shipping/add_pickup_order', $meta, $this->data);
    }

    function getBOL()
    {
      $this->page_construct('shipping/list_of_bol', $meta, $this->data);
    }
    ...
    function index($warehouse_id = NULL)
    {
        ...
        $this->page_construct('shipping/index', $meta, $this->data);
    }

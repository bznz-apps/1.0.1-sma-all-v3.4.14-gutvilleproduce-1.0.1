...
class Sales extends MY_Controller
{
    ...
    public function index($warehouse_id = null)
    {
        ...
        // EDIT
        // If Owner or Admin
        //    Load all sales, option to select by warehouse/store
        // Else If Sales Employee (salesman)
        //    Load only sales where salesman id === current logged in salesman
        // SAME APPLIES WHEN LOOKING AT THE CLIENTS/CUSTOMERS table
    ...
    public function getSales($warehouse_id = null)
    {
        ...
        // Table Column 'Actions' DropDown menu button
        // Variables - Used in the dropdown menu
        ...
        // Variable that containts html tags for the dropdown menu
        ...
        // Here DATATABLES Library does all the tasks the model would do
        // DATATABLES executes all the database queries needed to return data

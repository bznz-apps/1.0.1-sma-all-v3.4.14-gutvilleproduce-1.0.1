...
class Warehouses extends MY_Controller
{
    ...
    {
      $this->page_construct('warehouses/list_of_warehouses', $meta, $this->data);
    }

    function addWarehouse()
    {
      $this->page_construct('warehouses/add_warehouse', $meta, $this->data);
    }
    ...
    function index($warehouse_id = NULL)
    {
        ...
        $this->page_construct('warehouses/index', $meta, $this->data);
    }

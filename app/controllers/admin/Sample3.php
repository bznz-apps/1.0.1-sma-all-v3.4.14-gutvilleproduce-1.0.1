...
class Sample3 extends MY_Controller
{
    ...
    //   // $this->load->view($this->theme . 'sample_views/view3', $this->data);
    //   // Use this to load view inside SMA custom footer and header, sidebar
    //   // $this->page_construct('sample_views/view3', $meta, $this->data);
    // }

    function loadViewSample3()
    {
      $this->load->view($this->theme . 'sample3/index', $this->data);
    }

    function pageConstructSample3()
    {
      $this->page_construct('sample3/index', $meta, $this->data);
    }

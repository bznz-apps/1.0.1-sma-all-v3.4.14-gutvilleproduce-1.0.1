...
class Sample5 extends MY_Controller
{
    ...
    //   // $this->load->view($this->theme . 'sample_views/view5', $this->data);
    //   // Use this to load view inside SMA custom footer and header, sidebar
    //   // $this->page_construct('sample_views/view5', $meta, $this->data);
    // }

    function loadViewSample5()
    {
      $this->load->view($this->theme . 'sample5/index', $this->data);
    }

    function pageConstructSample5()
    {
      $this->page_construct('sample5/index', $meta, $this->data);
    }

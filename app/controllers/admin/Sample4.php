...
class Sample4 extends MY_Controller
{
    ...
    //   // $this->load->view($this->theme . 'sample_views/view4', $this->data);
    //   // Use this to load view inside SMA custom footer and header, sidebar
    //   // $this->page_construct('sample_views/view4', $meta, $this->data);
    // }

    function loadViewSample4()
    {
      $this->load->view($this->theme . 'sample4/index', $this->data);
    }

    function pageConstructSample4()
    {
      $this->page_construct('sample4/index', $meta, $this->data);
    }
